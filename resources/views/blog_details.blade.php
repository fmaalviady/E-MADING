            ...
            <div class="col-lg-8 posts-list">
               <div class="single-post">
                  <div class="feature-img">
                     <img class="img-fluid" src="{{ $article->foto ? asset('storage/articles/' . $article->foto) : asset('assets/img/blog/single_blog_1.png') }}" alt="{{ $article->judul }}">
                  </div>
                  <div class="blog_details">
                     <h2>{{ $article->judul }}</h2>
                     <ul class="blog-info-link mt-3 mb-4">
                        <li><a href="#"><i class="fa fa-user"></i> {{ $article->user->name ?? 'Admin' }}</a></li>
                        <li><a href="#"><i class="fa fa-calendar"></i> {{ \Carbon\Carbon::parse($article->tanggal)->format('d M Y') }}</a></li>
                        <li><a href="#"><i class="fa fa-tag"></i> {{ $article->category->nama_kategori ?? 'Umum' }}</a></li>
               ...
               <div class="navigation-top">
                  <div class="d-sm-flex justify-content-between text-center">
                     <p class="like-info"><span class="align-middle"><i class="fa fa-heart"></i></span> {{ $article->likes->count() }} orang menyukai ini</p>
               ...
               <div class="blog-author">
                  <div class="media align-items-center">
                     ...
                     <div class="media-body">
                        <a href="#">
                           <h4>{{ $article->user->name ?? 'Admin' }}</h4>
                        </a>
                        <p>Penulis artikel ini</p>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="comment-list">
                     <div class="single-comment justify-content-between d-flex">
                        <div class="user justify-content-between d-flex">
                           ...
                           <div class="desc">
                              <p class="comment">{{ $comment->isi }}</p>
                              <div class="d-flex justify-content-between">
                                 <div class="d-flex align-items-center">
                                    <h5><a href="#">{{ $comment->user->name ?? 'Anonymous' }}</a></h5>
                                    <p class="date">{{ \Carbon\Carbon::parse($comment->created_at)->format('F d, Y \a\t h:i A') }}</p>
                                 </div>
                              </div>
                           </div>
                        </div>
